  ...
  return (
    <div className="w-full">
      ...
      <div className="flex mb-4">
        <button
          className={`px-3 py-1 text-sm rounded-l-md ${viewType === 'day' ? 'bg-indigo-600 text-white' : 'bg-gray-100'}`}
          onClick={() => setViewType('day')}
        >
          Today
        </button>
        <button 
          className={`px-3 py-1 text-sm ${viewType === 'week' ? 'bg-indigo-600 text-white' : 'bg-gray-100'}`}
